                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-x-4 text-xs text-[#9a9a9a]">
                        <span className="flex items-center gap-1"><MapPin size={10}/>{audit.lokacija || '—'}</span>
                        <span className="flex items-center gap-1"><Calendar size={10}/>{new Date(audit.datum).toLocaleDateString('hr-HR')}</span>
                      </div>
                    </div>
