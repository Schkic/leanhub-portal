...
const inputClass = "w-full pl-10 pr-4 py-2.5 border border-[#e2e2e2] rounded-xl text-sm focus:border-[#1a7a5e] outline-none transition-all [&::-webkit-credentials-auto-fill-button]:hidden [&::-webkit-contacts-auto-fill-button]:hidden";
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required className={inputClass} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" />
              </div>
            </div>
